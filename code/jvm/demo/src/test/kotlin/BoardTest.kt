...
class BoardTest {
    ...
    @BeforeEach
    fun setupBoard() {
        board = createBoard(Player.WHITE)
    ...
    fun `Game win`() {
        ...
        board = board.play(Position(0.indexToRow(), 1.indexToColumn()), Player.WHITE)
        board = board.play(Position(1.indexToRow(), 1.indexToColumn()), Player.BLACK)
        ...
        board = board.play(Position(0.indexToRow(), 3.indexToColumn()), Player.WHITE)
        board = board.play(Position(1.indexToRow(), 3.indexToColumn()), Player.BLACK)
